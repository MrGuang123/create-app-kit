...
export function adjust_brightness(data, factor) {
    ...
    wasm.adjust_brightness(ptr0, len0, data, factor);
}
 ...
 * @returns {number}
 */
export function count_primes(max) {
    const ret = wasm.count_primes(max);
    return ret >>> 0;
}
 ...
 * @returns {bigint}
 */
export function fibonacci_iterative(n) {
    const ret = wasm.fibonacci_iterative(n);
    return BigInt.asUintN(64, ret);
}
 ...
 * @returns {bigint}
 */
export function fibonacci_recursive(n) {
    const ret = wasm.fibonacci_recursive(n);
    return BigInt.asUintN(64, ret);
}
 ...
 * @returns {number}
 */
export function get_nth_prime(n) {
    const ret = wasm.get_nth_prime(n);
    return ret >>> 0;
}
 ...
 */
export function quick_sort(data) {
    var ptr0 = passArray32ToWasm0(data, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    wasm.quick_sort(ptr0, len0, data);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('compute_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
